...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            var owner = await CheckUserAsync("2020", "Luis", "Nuñez", "luis.albiazul@hotmail.com", "156814963", "Espora 2052", "Owner");
            var lessee = await CheckUserAsync("3030", "Luis", "Nuñez", "luis.nunez@solflix.com", "156814963", "Espora 2052", "Lessee");
